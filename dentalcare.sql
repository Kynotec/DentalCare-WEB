...
(1, 'DornoDente', '2024-01-27', '12:00:00', 'Realizado', 3, 2),
(5, 'ConsultadeRotina', '2024-02-09', '10:00:00', 'Pago', 2, 3),
...
(1, 10, 'Pasta', 'A pasta de dentes permite ajudar a remover a placa bacteriana e restos de alimentos. ', 4, 10, 3, 1),
(2, 9, 'Escova', 'A escova de dentes como o nome indica, é o que permite escovar os dentes.', 2, 32, 1, 1),
...
(5, 10, 'FioDentário', 'O uso do fio dental remove a placa bacteriana e os alimentos nos lugares onde a escova não consegue chegar facilmente.', 7.2, 23, 1, 1),
(6, 10, 'Goteira', 'A Goteira evita uma regressão do alinhamento dentário, principalmente durante a noite.', 95.8, 22, 1, 2);
...
(2, 'Joao', '925847878', 'Rua de Almeiriga, Matosinhos', '954878458', '4455-417', 2),
...
ALTER TABLE `linha_carrinhos`
  ADD CONSTRAINT `linha_carrinhos_ibfk_2` FOREIGN KEY (`produto_id`) REFERENCES `produtos` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `linha_carrinhos_ibfk_3` FOREIGN KEY (`carrinho_id`) REFERENCES `carrinhos` (`id`) ON DELETE CASCADE;

--
-- Limitadores para a tabela `linha_faturas`
--
ALTER TABLE `linha_faturas`
  ADD CONSTRAINT `linha_faturas_ibfk_1` FOREIGN KEY (`fatura_id`) REFERENCES `faturas` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `linha_faturas_ibfk_2` FOREIGN KEY (`produto_id`) REFERENCES `produtos` (`id`) ON DELETE CASCADE,
  ADD CONSTRAINT `linha_faturas_ibfk_3` FOREIGN KEY (`servico_id`) REFERENCES `servicos` (`id`) ON DELETE CASCADE;
