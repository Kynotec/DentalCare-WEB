...
class ConsultaTest extends \Codeception\Test\Unit
{
    ...
    public function testcreateConsultaSuccessfully()
    {
        ...
        $this->tester->seeRecord('common\models\Marcacao', array('descricao' => 'Destartarização', 'data' => '2022-12-29', 'hora' => '02:10:00', 'estado' => 'Por Realizar'));
    }
