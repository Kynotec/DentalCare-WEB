...
/* @var $searchModel backend\models\SearchAdministrador */
        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body">
                    <div class="row mb-2">
                        <div class="col-md-12">
                            <?= Html::a('Criar Administrador', ['user/create', 'userType' => 'administrador'], ['class' => 'btn btn-success', ]) ?>
                        </div>
                    </div>
                        ...
                        'columns' => [
                            ...
                            [
                                ...
                                'buttons' => [
                                    ...
                                    {
                                        return Html::a('<i class="fas fa-eye"></i>', ['administrador/view', 'id' => $model->user_id], ['class' => 'btn btn-primary']);
                                    },
                                    'update' => function($url, $model)
                                    {
                                        if (Yii::$app->user->can('updateUtilizador')) {
                                            return Html::a('<i class="fas fa-pencil-alt text-white"></i>', ['administrador/update', 'id' => $model->user_id], ['class' => 'btn btn-warning mr-1']);
                                        }
                                    },
                                        ...
                                        if (Yii::$app->user->can('disableUtilizador')) {
                                            ...
                                            if($model->user->status == User::STATUS_ACTIVE)
                                            {
                                                return Html::a("<span class='material-symbols-outlined' style='font-variation-settings: \"FILL\" 1, \"wght\" 400, \"GRAD\" 200, \"opsz\" 20; padding-bottom: 0;'>toggle_off</span>", ['desativar', 'user_id' => $model->user_id], [
                                                    ...
                                                    'data'=> [
                                                        'confirm' => 'Tem a certeza que quer desativar este Administrador?'
                                                    ]
                                                ]);
                                            }
                                            else
                                            {
                                                return Html::a("<span class='material-symbols-outlined'  style='font-variation-settings: \"FILL\" 1, \"wght\" 400, \"GRAD\" 200, \"opsz\" 20; padding-bottom: 0;'>toggle_on</span>", ['ativar', 'user_id' => $model->user_id], [
                                                    ...
                                                    'data'=> [
                                                        'confirm' => 'Tem a certeza que quer ativar este Administrador?'
                                                    ]
                                                ]);
                                            }
                                        }
