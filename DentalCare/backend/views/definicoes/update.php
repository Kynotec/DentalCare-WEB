                    ...
                    <div class="card-block text-center">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6">
                                ...
                                <h6 class="text-muted f-w-400"><?= $form->field($model, 'morada')->textInput(['maxlength' => true]) ?>

                            </div>
                            <div class="col-sm-12">
                                <span class='material-symbols-outlined'>location_on</span>
                                <h6 class="text-muted f-w-400"><?= $form->field($model, 'codigopostal')->textInput(['maxlength' => true]) ?></h6>
